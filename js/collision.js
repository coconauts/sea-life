...
function Collision(){
  ...
  this.isCollidingDirection = function(obj1, obj2, direction, offset){
    switch(direction){
      case LEFT:  return collision.containsLeft(obj1, obj2, SIZE, offset);
      case RIGHT: return collision.containsRight(obj1, obj2, SIZE, offset);
      case UP: return collision.containsUp(obj1, obj2, SIZE, offset);
      case DOWN:  return collision.containsDown(obj1, obj2, SIZE, offset);
